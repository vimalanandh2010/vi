                ...
                <div className="mb-4 w-[340px] sm:w-[380px] h-[500px] max-h-[70vh] bg-white border border-gray-200 rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-5 duration-300">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-100 text-black">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-black tracking-tight text-sm text-black">AI Career Assistant</h3>
                        </div>
                        <button
                        ...
                        {messages.map((msg, index) => (
                            <div key={index} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'} w-full`}>
                                <div className={`flex gap-2 max-w-[85%] ${msg.role === 'user' ? 'flex-row-reverse' : 'flex-row'}`}>
                                    {/* Avatar */}
                                    <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-1 ${msg.role === 'user' ? 'bg-black' : 'bg-gray-100 border border-gray-200'}`}>
                        ...
                        {isLoading && (
                            <div className="flex justify-start w-full">
                                <div className="flex gap-2 max-w-[85%] flex-row">
                                    <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-1 bg-gray-100 border border-gray-200">
