        ...
        <div className="space-y-10">
            <div className="flex justify-between items-center px-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-xl font-black text-gray-900 tracking-tight">Portfolio & Projects</h3>
                        <p className="text-gray-500 text-xs font-bold uppercase tracking-widest">{projects.length} Total Projects</p>
                    </div>
                </div>
                <button
                    onClick={() => handleOpen()}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {projects.map((proj, idx) => (
                    ...
                    >
                        ...
                        <div className="mb-6">
                            <h4 className="text-2xl font-black text-black mb-2">{proj.title}</h4>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {(proj.technologies || []).map((tech, i) => (
                                    <span key={i} className="px-3 py-1 bg-gray-50 border border-gray-200 rounded-lg text-[10px] font-black text-gray-500 uppercase tracking-widest">{tech.trim()}</span>
                                ))}
                            </div>
                        </div>
                ...
                {projects.length === 0 && (
                    <div className="col-span-full text-center py-20 bg-gray-50 border border-dashed border-gray-200 rounded-[3rem]">
                        <p className="text-gray-500 font-bold italic">Showcase your work. Add your first project card.</p>
                    </div>
                )}
            </div>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-slate-900/40 backdrop-blur-md">
                        ...
                        >
                            <div className="px-10 py-8 border-b border-gray-100 flex items-center justify-between">
                                <h3 className="text-2xl font-black text-black tracking-tight">Project Details</h3>
                            ...
                            <div className="p-10 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Live URL / Demo Link</label>
                                            <input
                                                value={formData.link}
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Tech Stack (comma separated)</label>
                                            <input
