                                                ...
                                                <div className="flex flex-col md:flex-row justify-between gap-8">
                                                    ...
                                                    <div className="flex flex-row md:flex-col items-center md:items-end justify-between gap-6 border-t md:border-t-0 md:border-l border-slate-50 pt-6 md:pt-0 md:pl-8">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center gap-3 px-8 py-3.5 bg-black hover:bg-slate-800 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all shadow-xl shadow-black/10 group-hover:scale-105 active:scale-95"
                                                        >
                                                            Profile
