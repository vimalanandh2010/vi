...
const ChatPage = () => {
    ...
    const chatContent = (
        <div className="flex flex-1 h-full text-slate-900 font-sans overflow-hidden">
            {/* Sidebar */}
    ...
    return (
        <div className="flex flex-col h-screen bg-white">
            <Navbar />
            <div className="flex flex-1 h-[calc(100vh-64px)] lg:h-[calc(100vh-80px)] overflow-hidden">
                {chatContent}
            </div>
        </div>
    );
